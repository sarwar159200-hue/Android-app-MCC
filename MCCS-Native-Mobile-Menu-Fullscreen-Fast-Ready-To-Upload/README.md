...
Upload the contents of this folder to the root of an empty GitHub repository. Open **Actions**, run **Build MCCS Android APK**, then download the `MCCS-Android-APK` artifact.
